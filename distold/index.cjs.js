...
var Button = function (_a) {
    ...
    return (React__default['default'].createElement(StyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled, style: { position: "relative", overflow: "hidden" } }),
        ...
        React__default['default'].createElement("div", { className: "btn_shiny" })));
};
Button.defaultProps = {
...
var Icon$q = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React__default['default'].createElement("image", { width: "818", height: "100", href: "/images/egg/logo.png" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React__default['default'].createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "primaryBright" }, props)));
    }
...
var LinkExternal = function (_a) {
    ...
    return (React__default['default'].createElement(Link, __assign({ external: true }, props),
        children,
        React__default['default'].createElement(Icon$t, { color: "rgba(47, 75, 96, 0.6)", ml: "4px" })));
};
...
var SpinnerIcon = function (props) {
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React__default['default'].createElement("image", { width: "96", height: "96", href: "/images/spinner.png" })));
};
...
var Modal = function (_a) {
    var title = _a.title, onDismiss = _a.onDismiss, onBack = _a.onBack, children = _a.children, _b = _a.hideCloseButton, hideCloseButton = _b === void 0 ? false : _b, _c = _a.bodyPadding, bodyPadding = _c === void 0 ? "24px" : _c, className = _a.className;
    return (React__default['default'].createElement(StyledModal, { className: className },
        React__default['default'].createElement(ModalHeader, null,
            !hideCloseButton && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React__default['default'].createElement(Icon$k, { color: "rgba(47, 75, 96, 0.4)" }))),
            React__default['default'].createElement(ModalTitle, null,
                onBack && (React__default['default'].createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React__default['default'].createElement(Icon$5, { color: "rgba(47, 75, 96, 0.4)" }))),
                React__default['default'].createElement(Heading, { style: { color: "rgba(47, 75, 96, 0.5)", margin: "auto", fontSize: "18px", fontWeight: 500 } }, title))),
...
var Logo = function (_a) {
    ...
    return (React__default['default'].createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React__default['default'].createElement("image", { width: "87", height: "30", href: isDark ? 'images/navw.png' : 'images/navw.png' })));
};
...
var MENU_HEIGHT = 64;
var MENU_ENTRY_HEIGHT = 42;
var SIDEBAR_WIDTH_FULL = 240;
var SIDEBAR_WIDTH_REDUCED = 90;

var rainbowAnimation = styled.keyframes(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
...
var MenuEntry = styled__default['default'].div(templateObject_3$6 || (templateObject_3$6 = __makeTemplateObject(["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";;\n  color: ", ";\n  // box-shadow: ", ";\n  border-radius:12px;\n  margin: 0px 26px 6px;\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    color: ", ";\n  }\n\n  svg {\n    fill:  ", ";\n    width:18px\n  }\n\n  &:hover {\n    background-color:#8dc971;\n    color:#fff;\n    svg {\n      fill:  #fff;\n    }\n    a {\n      color:#fff;\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"], ["\n  cursor: pointer;\n  display: flex;\n  align-items: center;\n  height: ", "px;\n  padding: ", ";\n  font-size: ", ";\n  background-color: ", ";;\n  color: ", ";\n  // box-shadow: ", ";\n  border-radius:12px;\n  margin: 0px 26px 6px;\n\n  a {\n    display: flex;\n    align-items: center;\n    width: 100%;\n    height: 100%;\n    color: ", ";\n  }\n\n  svg {\n    fill:  ", ";\n    width:18px\n  }\n\n  &:hover {\n    background-color:#8dc971;\n    color:#fff;\n    svg {\n      fill:  #fff;\n    }\n    a {\n      color:#fff;\n    }\n  }\n\n  // Safari fix\n  flex-shrink: 0;\n\n  &.rainbow {\n    -webkit-background-clip: text;\n    animation: ", " 3s ease-in-out infinite;\n    background: ", ";\n    background-size: 200% 100%;\n    font-weight: bold;\n  }\n"])), MENU_ENTRY_HEIGHT, function (_a) {
    ...
    return (isActive ? "#8dc971" : "transparent");
}, function (_a) {
    var isActive = _a.isActive; _a.theme;
    return (isActive ? "#fff" : "#57565c");
}, function (_a) {
...
var AccordionContent = styled__default['default'].div(templateObject_2$b || (templateObject_2$b = __makeTemplateObject(["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-width: 1px;\n"], ["\n  max-height: ", ";\n  transition: max-height 0.3s ease-out;\n  overflow: hidden;\n  border-color: ", ";\n  border-style: solid;\n  border-width: 1px;\n"])), function (_a) {
    var isOpen = _a.isOpen; _a.maxHeight;
    return (isOpen ? "120px" : 0);
}, function (_a) {
...
var PanelBody = function (_a) {
    var isDark = _a.isDark, isPushed = _a.isPushed, pushNav = _a.pushNav, isMobile = _a.isMobile, links = _a.links;
    var location = reactRouterDom.useLocation();
    // Close the menu when a user clicks a link on mobile
    var handleClick = isMobile ? function () { return pushNav(false); } : undefined;
    return (React__default['default'].createElement(Container$3, null,
        React__default['default'].createElement("img", { width: "160", height: "51", src: isDark ? 'images/hiroshi/logo.png' : 'images/hiroshi/logo.png', alt: "navimg", className: "navlogo" }),
        links.map(function (entry) {
            var Icon = Icons[entry.icon];
            var iconElement = React__default['default'].createElement(Icon, { width: "24px", mr: "8px" });
            var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
            if (entry.items) {
                return (React__default['default'].createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass + " menulinkouter" }, isPushed &&
                    entry.items.map(function (item) { return (React__default['default'].createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, className: "navaccordion" },
                        React__default['default'].createElement(MenuLink, { target: item.external ? "_blank" : "", href: item.href }, item.label))); })));
            }
            return (React__default['default'].createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass + " menulinkouter" },
                React__default['default'].createElement(MenuLink, { target: entry.external ? "_blank" : "", href: entry.href, onClick: handleClick },
                    iconElement,
...
var PanelFooter = function (_a) {
    _a.isPushed; _a.pushNav; _a.toggleTheme; _a.isDark; var cakePriceUsd = _a.cakePriceUsd, violaPriceUsd = _a.violaPriceUsd, linkviola = _a.linkviola; _a.linkmelody; _a.currentLang; _a.langs; _a.setLang; _a.priceLink;
    // if (!isPushed) {
    // return (
    //   <Container>
        ...
        React__default['default'].createElement(SettingsEntry, null,
            React__default['default'].createElement(SocialEntry, { style: { display: "flex", justifyContent: "center" } }, (cakePriceUsd && violaPriceUsd) ? (React__default['default'].createElement(PriceLink, null,
                React__default['default'].createElement("div", { className: "priceouter" },
                    React__default['default'].createElement("a", { href: linkviola },
                        React__default['default'].createElement(Text, { color: "textSubtle", bold: true },
                            React__default['default'].createElement("span", null, "$"), "" + cakePriceUsd.toFixed(3)))))) : (React__default['default'].createElement(Skeleton, { width: 80, height: 24 }))),
...
var Panel = function (props) {
    ...
    return (React__default['default'].createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, className: "styledpanelcss" },
...
var WalletCard = function (_a) {
    ...
    return (React__default['default'].createElement(Button, { fullWidth: true, variant: "tertiary", onClick: function () {
            ...
            onDismiss();
        }, style: { justifyContent: "space-between" }, mb: mb, className: "connectmodalbtns", id: "wallet-connect-" + title.toLocaleLowerCase() },
        React__default['default'].createElement(Text, { bold: true, color: "text", mr: "16px" }, title),
        React__default['default'].createElement(Icon, { width: "32px" })));
};

var HelpLink = styled__default['default'](Link)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React__default['default'].createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss, className: "connectmodal" },
        ...
        React__default['default'].createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true, className: "connctlinkmodal", style: { color: "#2F4B60" } },
            React__default['default'].createElement(Icon$o, { mr: "6px", color: "#2F4B60" }),
            "Learn how to connect")));
};
var templateObject_1$D;

var StyleButton = styled__default['default'](Text).attrs({ role: "button" })(templateObject_1$E || (templateObject_1$E = __makeTemplateObject(["\n  position: relative;\n  display: flex;\n  align-items: center;\n  color: rgba(47, 75, 96, 0.6);\n"], ["\n  position: relative;\n  display: flex;\n  align-items: center;\n  color: rgba(47, 75, 96, 0.6);\n"])));
...
var CopyToClipboard = function (_a) {
    ...
    return (React__default['default'].createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React__default['default'].createElement(Icon$n, { width: "20px", color: "rgba(47, 75, 96, 0.6)", ml: "4px" }),
...
var AccountModal = function (_a) {
    ...
    return (React__default['default'].createElement(Modal, { title: "Your wallet", onDismiss: onDismiss, className: "modalwallet" },
        React__default['default'].createElement("img", { src: "images/hiroshi/userimg.png", alt: "user", className: "useridimg" }),
        React__default['default'].createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px", color: "rgba(47, 75, 96, 0.6)" } }, account),
        React__default['default'].createElement(Flex, { mb: "32px", justifyContent: "space-between" },
            React__default['default'].createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px", style: { color: "rgba(47, 75, 96, 0.6)" } }, "View on BscScan"),
...
var UserBlock = function (_a) {
    ...
    return (React__default['default'].createElement("div", { className: "connectBtn" }, account ? (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } },
        React__default['default'].createElement("img", { src: "images/hiroshi/face.png", alt: "connect" }),
        accountEllipsis)) : (React__default['default'].createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
            onPresentConnectModal();
        } }, "Connect"))));
};

var Wrapper$1 = styled__default['default'].div(templateObject_1$F || (templateObject_1$F = __makeTemplateObject(["\n  position: relative;\n  width: 100%;\n"], ["\n  position: relative;\n  width: 100%;\n"])));
var StyledNav = styled__default['default'].nav(templateObject_2$e || (templateObject_2$e = __makeTemplateObject(["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"], ["\n  position: fixed;\n  top: ", ";\n  left: 0;\n  transition: top 0.2s;\n  display: flex;\n  justify-content: space-between;\n  align-items: center;\n  padding-left: 8px;\n  padding-right: 16px;\n  width: 100%;\n  height: ", "px;\n  background-color: ", ";\n  border-bottom: solid 2px rgba(133, 133, 133, 0.1);\n  z-index: 20;\n  transform: translate3d(0, 0, 0);\n"])), function (_a) {
    var showMenu = _a.showMenu;
    ...
    return (React__default['default'].createElement(Wrapper$1, null,
        React__default['default'].createElement(StyledNav, { showMenu: showMenu, className: "menutopdesk" },
            React__default['default'].createElement("div", { className: "menutopdeskinner" },
                React__default['default'].createElement("div", { className: "logoleft" },
                    ...
                    React__default['default'].createElement("div", { className: "navigation" },
                        React__default['default'].createElement("input", { className: "menu-icon", type: "checkbox", id: "menu-icon", name: "menu-icon" }),
                        // @ts-ignore}
                        React__default['default'].createElement("label", { for: "menu-icon" }),
                        React__default['default'].createElement("div", { className: "text" }, "Menu"),
                        React__default['default'].createElement("nav", { className: "navigation__nav" },
                            React__default['default'].createElement("ul", { className: "navigation__list" },
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "#", className: "navigation__link" }, "coingecko")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "#", className: "navigation__link" }, "coinmarketcap")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "#", className: "navigation__link" }, "roadmap")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "#", className: "navigation__link" }, "audited by hacken")))))),
                React__default['default'].createElement("div", { className: "menuconntouter" },
                    React__default['default'].createElement("div", { className: "menulinkouter" },
                        ...
                        React__default['default'].createElement("div", { className: "dropdown" },
                            React__default['default'].createElement("input", { type: "checkbox", id: "dropdown" }),
                            // @ts-ignore}
                            React__default['default'].createElement("label", { className: "dropdown__face", for: "dropdown" },
                                React__default['default'].createElement("div", { className: "dropdown__text" },
                                    React__default['default'].createElement("img", { src: "images/link.png", alt: "Link" })),
                                React__default['default'].createElement("div", { className: "dropdown__arrow" })),
                            React__default['default'].createElement("ul", { className: "dropdown__items" },
                                React__default['default'].createElement("li", null,
                                    " ",
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Instagram", href: "https://instagram.com/kabosubsc" },
                                        React__default['default'].createElement("i", { className: "fab fa-instagram" }))),
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Medium", href: "https://medium.com/@KabosuToken" },
                                        React__default['default'].createElement("i", { className: "fab fa-medium" }))),
                                React__default['default'].createElement("li", null,
                                    " ",
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Telegram", href: "https://t.me/kabosuchat" },
                                        React__default['default'].createElement("i", { className: "fas fa-paper-plane" }))),
                                React__default['default'].createElement("li", null,
                                    React__default['default'].createElement("a", { target: "_blank", "aria-label": "Twitter", href: "https://twitter.com/KabosuOfficial" },
                                        React__default['default'].createElement("i", { className: "fab fa-twitter" })))))),
                    React__default['default'].createElement("div", { className: "connectrowouter" },
                        React__default['default'].createElement("a", { href: "https://exchange.hiroshi.farm/", className: "nav_link outlineBtn exchangemenubtn" }, "Exchange"),
                        React__default['default'].createElement("a", { href: "https://hiroshi.farm/", className: "nav_link outlineBtn backtofarmbtn" }, "Back to Farm"),
...
var lightColors = __assign(__assign(__assign({}, baseColors), brandColors), { background: "#FAF9FA", backgroundDisabled: "#E9EAEB", contrast: "#191326", invertedContrast: "#FFFFFF", input: "#ededed", tertiary: "#EFF4F5", text: "#2F4B60  ", textDisabled: "#BDC2C4", textSubtle: "#766d78", borderColor: "#E9EAEB", card: "#FFFFFF", gradients: {
...
var light$1 = (_a$2 = {},
    ...
    _a$2[SUBTLE] = {
        background: "#38A2BA",
        backgroundActive: "#38A2BA",
        backgroundHover: "#38A2BA",
        border: 0,
        borderColorHover: "currentColor",
        boxShadow: "none",
        boxShadowActive: "none",
