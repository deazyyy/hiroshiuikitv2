...
var Button = function (_a) {
    ...
    return (React.createElement(StyledButton, __assign({}, internalProps, props, { isLoading: isLoading, disabled: isDisabled, style: { position: "relative", overflow: "hidden" } }),
        ...
        React.createElement("div", { className: "btn_shiny" })));
};
Button.defaultProps = {
...
var Icon$q = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 32 32" }, props),
        React.createElement("image", { width: "818", height: "100", href: "/images/egg/logo.png" })));
};
...
var ButtonMenuItem = function (_a) {
    ...
    if (!isActive) {
        return (React.createElement(InactiveButton, __assign({ forwardedAs: as, size: size, variant: "tertiary", colorKey: variant === variants.PRIMARY ? "primary" : "primaryBright" }, props)));
    }
...
var LinkExternal = function (_a) {
    ...
    return (React.createElement(Link, __assign({ external: true }, props),
        children,
        React.createElement(Icon$t, { color: "rgba(47, 75, 96, 0.6)", ml: "4px" })));
};
...
var SpinnerIcon = function (props) {
    return (React.createElement(Svg, __assign({ viewBox: "0 0 96 96" }, props),
        React.createElement("image", { width: "96", height: "96", href: "/images/spinner.png" })));
};
    ...
    return (React.createElement(StyledModal, { className: className },
        React.createElement(ModalHeader, null,
            !hideCloseButton && (React.createElement(IconButton, { variant: "text", onClick: onDismiss, "aria-label": "Close the dialog" },
                React.createElement(Icon$k, { color: "rgba(47, 75, 96, 0.4)" }))),
            React.createElement(ModalTitle, null,
                onBack && (React.createElement(IconButton, { variant: "text", onClick: onBack, "area-label": "go back", mr: "8px" },
                    React.createElement(Icon$5, { color: "rgba(47, 75, 96, 0.4)" }))),
                React.createElement(Heading, { style: { color: "rgba(47, 75, 96, 0.5)", margin: "auto", fontSize: "18px", fontWeight: 500 } }, title))),
...
var Logo = function (_a) {
    ...
    return (React.createElement(Svg, __assign({ viewBox: "0 0 205 26" }, props),
        React.createElement("image", { width: "87", height: "30", href: isDark ? 'images/navw.png' : 'images/navw.png' })));
};
...
var Icon$S = function (props) { return (React.createElement(Svg, __assign({ viewBox: "0 0 24 24" }, props),
...
var rainbowAnimation = keyframes(templateObject_1$y || (templateObject_1$y = __makeTemplateObject(["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"], ["\n  0%,\n  100% {\n    background-position: 0 0;\n  }\n  50% {\n    background-position: 100% 0;\n  }\n"])));
...
var Container$2 = styled.div(templateObject_1$z || (templateObject_1$z = __makeTemplateObject(["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"], ["\n  display: flex;\n  flex-direction: column;\n  // Safari fix\n  flex-shrink: 0;\n"])));
...
var PanelBody = function (_a) {
    ...
    return (React.createElement(Container$3, null,
        React.createElement("img", { width: "160", height: "51", src: isDark ? 'images/hiroshi/logo.png' : 'images/hiroshi/logo.png', alt: "navimg", className: "navlogo" }),
        links.map(function (entry) {
            var Icon = Icons[entry.icon];
            var iconElement = React.createElement(Icon, { width: "24px", mr: "8px" });
            var calloutClass = entry.calloutClass ? entry.calloutClass : undefined;
            if (entry.items) {
                return (React.createElement(Accordion, { key: entry.label, isPushed: isPushed, pushNav: pushNav, icon: iconElement, label: entry.label, initialOpenState: entry.initialOpenState, className: calloutClass + " menulinkouter" }, isPushed &&
                    entry.items.map(function (item) { return (React.createElement(MenuEntry, { key: item.href, secondary: true, isActive: item.href === location.pathname, onClick: handleClick, className: "navaccordion" },
                        React.createElement(MenuLink, { target: item.external ? "_blank" : "", href: item.href }, item.label))); })));
            }
            return (React.createElement(MenuEntry, { key: entry.label, isActive: entry.href === location.pathname, className: calloutClass + " menulinkouter" },
                React.createElement(MenuLink, { target: entry.external ? "_blank" : "", href: entry.href, onClick: handleClick },
                    iconElement,
                ...
                React.createElement("div", { className: "priceouter" },
                    React.createElement("a", { href: linkviola },
                        React.createElement(Text, { color: "textSubtle", bold: true },
                            React.createElement("span", null, "$"), "" + cakePriceUsd.toFixed(3)))))) : (React.createElement(Skeleton, { width: 80, height: 24 }))),
...
var Panel = function (props) {
    ...
    return (React.createElement(StyledPanel, { isPushed: isPushed, showMenu: showMenu, className: "styledpanelcss" },
...
var HelpLink = styled(Link)(templateObject_1$D || (templateObject_1$D = __makeTemplateObject(["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"], ["\n  display: flex;\n  align-self: center;\n  align-items: center;\n  margin-top: 24px;\n"])));
var ConnectModal = function (_a) {
    var login = _a.login, _b = _a.onDismiss, onDismiss = _b === void 0 ? function () { return null; } : _b;
    return (React.createElement(Modal, { title: "Connect to a wallet", onDismiss: onDismiss, className: "connectmodal" },
        ...
        React.createElement(HelpLink, { href: "https://docs.pancakeswap.finance/guides/faq#how-do-i-set-up-my-wallet-on-binance-smart-chain", external: true, className: "connctlinkmodal", style: { color: "#2F4B60" } },
            React.createElement(Icon$o, { mr: "6px", color: "#2F4B60" }),
...
var CopyToClipboard = function (_a) {
    ...
    return (React.createElement(StyleButton, __assign({ small: true, bold: true, onClick: function () {
        ...
        children,
        React.createElement(Icon$n, { width: "20px", color: "rgba(47, 75, 96, 0.6)", ml: "4px" }),
...
var AccountModal = function (_a) {
    ...
    return (React.createElement(Modal, { title: "Your wallet", onDismiss: onDismiss, className: "modalwallet" },
        React.createElement("img", { src: "images/hiroshi/userimg.png", alt: "user", className: "useridimg" }),
        React.createElement(Text, { fontSize: "20px", bold: true, style: { whiteSpace: "nowrap", overflow: "hidden", textOverflow: "ellipsis", marginBottom: "8px", color: "rgba(47, 75, 96, 0.6)" } }, account),
        React.createElement(Flex, { mb: "32px", justifyContent: "space-between" },
            React.createElement(LinkExternal, { small: true, href: "https://bscscan.com/address/" + account, mr: "16px", style: { color: "rgba(47, 75, 96, 0.6)" } }, "View on BscScan"),
...
var UserBlock = function (_a) {
    ...
    return (React.createElement("div", { className: "connectBtn" }, account ? (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
            onPresentAccountModal();
        } },
        React.createElement("img", { src: "images/hiroshi/face.png", alt: "connect" }),
        accountEllipsis)) : (React.createElement(Button, { size: "sm", variant: "tertiary", onClick: function () {
    ...
    return (React.createElement(Wrapper$1, null,
        React.createElement(StyledNav, { showMenu: showMenu, className: "menutopdesk" },
            React.createElement("div", { className: "menutopdeskinner" },
                React.createElement("div", { className: "logoleft" },
                    ...
                    React.createElement("div", { className: "navigation" },
                        ...
                        React.createElement("nav", { className: "navigation__nav" },
                            React.createElement("ul", { className: "navigation__list" },
                                React.createElement("li", { className: "navigation__item" },
                                    React.createElement("a", { href: "#", className: "navigation__link" }, "coingecko")),
                                React.createElement("li", { className: "navigation__item" },
                                    React.createElement("a", { href: "#", className: "navigation__link" }, "coinmarketcap")),
                                React.createElement("li", { className: "navigation__item" },
                                    React.createElement("a", { href: "#", className: "navigation__link" }, "roadmap")),
                                React.createElement("li", { className: "navigation__item" },
                                    React.createElement("a", { href: "#", className: "navigation__link" }, "audited by hacken")))))),
                    ...
                    React.createElement("div", { className: "connectrowouter" },
                        React.createElement("div", { className: "dropdown" },
                            ...
                            React.createElement("label", { className: "dropdown__face", for: "dropdown" },
                                ...
                                React.createElement("div", { className: "dropdown__arrow" })),
                            React.createElement("ul", { className: "dropdown__items" },
                                React.createElement("li", null,
                                    " ",
                                    React.createElement("a", { target: "_blank", "aria-label": "Instagram", href: "https://instagram.com/kabosubsc" },
                                        React.createElement("i", { className: "fab fa-instagram" }))),
                                React.createElement("li", null,
                                    React.createElement("a", { target: "_blank", "aria-label": "Medium", href: "https://medium.com/@KabosuToken" },
                                        React.createElement("i", { className: "fab fa-medium" }))),
                                React.createElement("li", null,
                                    " ",
                                    React.createElement("a", { target: "_blank", "aria-label": "Telegram", href: "https://t.me/kabosuchat" },
                                        React.createElement("i", { className: "fas fa-paper-plane" }))),
                                React.createElement("li", null,
                                    React.createElement("a", { target: "_blank", "aria-label": "Twitter", href: "https://twitter.com/KabosuOfficial" },
                                        React.createElement("i", { className: "fab fa-twitter" }))))),
                        React.createElement("a", { href: "https://exchange.hiroshi.farm/", className: "nav_link outlineBtn exchangemenubtn" }, "Exchange"),
                        React.createElement("a", { href: "https://hiroshi.farm/", className: "nav_link outlineBtn backtofarmbtn" }, "Back to Farm"),
...
var alertTypeMap = (_a$1 = {},
    ...
    _a$1);
var StyledToast = styled.div(templateObject_1$G || (templateObject_1$G = __makeTemplateObject(["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"], ["\n  right: 16px;\n  position: fixed;\n  max-width: calc(100% - 32px);\n  transition: all 250ms ease-in;\n  width: 100%;\n\n  ", " {\n    max-width: 400px;\n  }\n"])), function (_a) {
    var theme = _a.theme;
    return theme.mediaQueries.sm;
});
...
var StyledToastContainer = styled.div(templateObject_1$H || (templateObject_1$H = __makeTemplateObject(["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"], ["\n  .enter,\n  .appear {\n    opacity: 0.01;\n  }\n\n  .enter.enter-active,\n  .appear.appear-active {\n    opacity: 1;\n    transition: opacity 250ms ease-in;\n  }\n\n  .exit {\n    opacity: 1;\n  }\n\n  .exit.exit-active {\n    opacity: 0.01;\n    transition: opacity 250ms ease-out;\n  }\n"])));
