                        ...
                        React__default['default'].createElement("nav", { className: "navigation__nav" },
                            React__default['default'].createElement("ul", { className: "navigation__list" },
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "https://www.coingecko.com/de/munze/kabosu", className: "navigation__link" }, "coingecko")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
                                    React__default['default'].createElement("a", { href: "https://coinmarketcap.com/de/currencies/kabosu/", className: "navigation__link" }, "coinmarketcap")),
                                React__default['default'].createElement("li", { className: "navigation__item" },
